...
export const AddApppoitment = ({ lastId, OnSendAppointment }) => {
  const EmptyForm = {
    petName: "",
    ownerName: "",
    aptDate: "",
  ...
  const SaveNewAppointment = (data) => {
    ...
    OnSendAppointment(appoitmentinfo);
    setToggleForm(false);
  };
  return (
    <div>
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                ...
                className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md"
                onChange={(e) => {
                  SetForm({ ...form, aptDate: e.target.value });
                }}
              />
            </div>
          </div>
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input
                ...
                className="max-w-lg block w-full shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md"
                onChange={(e) => {
                  SetForm({ ...form, aptTime: e.target.value });
                }}
              />
            </div>
          </div>
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <textarea
                ...
                onChange={(e) => {
                  SetForm({ ...form, aptNotes: e.target.value });
                }}
              ></textarea>
            </div>
          </div>
